...
else if($profil['PROFIL_ID']==14)
{
 ...
 $var_search = !empty($_POST['search']['value']) ? $_POST['search']['value'] : null;
        ...
        $order_column = array('NOM_CITOYEN', 'DATE');

        $order_by = isset($_POST['order']) ? ' ORDER BY ' . $order_column[$_POST['order']['0']['column']] . '  ' . $_POST['order']['0']['dir'] : ' ORDER BY NOM_CITOYEN ASC';

        $search = !empty($_POST['search']['value']) ? ("AND NOM_CITOYEN LIKE '%$var_search%'  ") : '';
