          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Psr_elements/update'); ?>">

                  <div class="row">

                    <div class="col-md-6">
                      <input type="hidden" class="form-control" name="ID_PSR_ELEMENT" value="<?= $membre['ID_PSR_ELEMENT'] ?>">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="date" name="DATE_NAISSANCE" autocomplete="off" id="DATE_NAISSANCE" value="<?= $membre['DATE_NAISSANCE'] ?>" class="form-control">
