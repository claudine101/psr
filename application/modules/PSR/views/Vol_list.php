  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" color="white">Traitement</h5>
  ...
  <div class="modal-body">
   <form id="add_form" method="post">
    <div class="modal-body mb-1">
        <input type="hidden" name="ID_INC" id="ID_INC" class="form-control" value=" ">
        <div class="row">
          <div class="col-md-6">
            <label for="nom">Civil</label>
            <input type="text" class="form-control" id="civl" name="civil" disabled>

          </div>
          <div class="col-md-6">
            <label for="prenom">Date</label>
            <input type="date" name="DATE_INSERTION" id="DATE_INSERTION" placeholder="Date de traitement" max="<?=date('Y-m-d') ?>" value="<?=set_value('DATE_INSERTION');?>" class="form-control" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="confirmation" name="confirmation" disabled>
          </div>
        </div> 
        <div class="row">
          <div class="col-md-6">
            <label for="nom">Confirmé par</label>
              <input type="text" class="form-control" id="confirmé" name="confirmé" disabled>
          </div>          
     ...
     <div class="modal-footer">
      <button type="button" class="btn btn-primary" onclick="validate_update()" id="modifier" data-dismiss="modal">Confirmer</button>
      <button type="button" class="btn btn-danger" data-dismiss="modal">Rejetter</button>
...
< <script type="text/javascript">
  ...
  "sSortDescending": ": activer pour trier la colonne par ordre d&eacute;croissant"
   ...
   function getDetailControl(id = 0) {
    ...
    $.ajax({
      url : "<?=base_url()?>PSR/Vol_Controller/detail/"+id,
      type : "POST",
      dataType: "JSON",
      cache:false,
      data: {ID:id},
...
<script type="text/javascript">
  ...
  function fin_trait(id)
  {
    ...
    alert(id);
    var url;  
    url = "<?php echo base_url('PSR/Vol_Controller/fin_valide')?>/"+id;
    $.ajax({
      url:url,
      type:"POST",
      contentType:false,
