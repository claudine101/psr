      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?= base_url('PSR/Poste_Pnb/index') ?>" class='btn btn-primary float-right'>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Poste_Pnb/add'); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text" name="LATITUDE" autocomplete="off" id="LATITUDE" value="-1" class="form-control">

                      <?php echo form_error('LATITUDE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-3">
                      <label for="FName"> Longitude</label>
                      <input type="text" name="LONGITUDE" autocomplete="off" id="LONGITUDE" value="-1" class="form-control">
