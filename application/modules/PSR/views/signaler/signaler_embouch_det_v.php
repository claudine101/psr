<section class="content" style="background-color: #f1f1f100;">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <input type="hidden" name="id" id="id" value="<?= $alerte['ID_AMBOUTEILLAGE']?>">
      <div class="col-md-6">
...
<!--  Script de validation -->
  ...
  function confirmer()
  {
    ...
    alert(id);
    var url;  
    url = "<?php echo base_url('PSR/Signalement_embouteillage/traiter_conf')?>/"+id;
...
<!-- Script pour rejetter -->
 ...
 <script type="text/javascript">
  ...
  function rejet()
  {
    ...
    alert(id);
    var url;  
    url = "<?php echo base_url('PSR/Signalement_embouteillage/traiter_rejet')?>/"+id;
