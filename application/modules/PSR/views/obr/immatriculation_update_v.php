                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Obr_Immatriculation/update'); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="TELEPHONE" autocomplete="off" id="TELEPHONE" value="<?= $membre['TELEPHONE'] ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="EMAIL" autocomplete="off" id="EMAIL" value="<?= $membre['EMAIL'] ?>" class="form-control">
