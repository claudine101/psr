                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="LABEL_REPONSE" autocomplete="off" id="FR2" value="<?= set_value('LABEL_REPONSE') ?>" class="form-control">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="INFRA_TRADUCTION" autocomplete="off" id="INFRA_TRADUCTION" value="<?= set_value('INFRA_TRADUCTION') ?>" class="form-control">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="DESC_TRADUCTION" autocomplete="off" id="DESC_TRADUCTION" value="<?= set_value('DESC_TRADUCTION') ?>" class="form-control">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="LABEL_TRADUCTION" autocomplete="off" id="LABEL_TRADUCTION" value="<?= set_value('LABEL_TRADUCTION') ?>" class="form-control">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="DESC_LABEL_TRADUCTION" autocomplete="off" id="DESC_LABEL_TRADUCTION" value="<?= set_value('DESC_LABEL_TRADUCTION') ?>" class="form-control">
