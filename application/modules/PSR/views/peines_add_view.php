                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Infra_peines/add'); ?>">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="AMENDES" autocomplete="off" id="FR" value="<?= set_value('AMENDES') ?>" class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="hidden" name="PEINES_TRADUCTION" autocomplete="off" id="PEINES_TRADUCTION" value="<?= set_value('PEINES_TRADUCTION') ?>" class="form-control">
