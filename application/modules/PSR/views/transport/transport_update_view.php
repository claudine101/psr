      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?= base_url('PSR/Transport/index') ?>" class='btn btn-primary float-right'>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Transport/update'); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="TELEPHONE" autocomplete="off" id="TELEPHONE" value="<?= $controles['TELEPHONE'] ?>" class="form-control">
