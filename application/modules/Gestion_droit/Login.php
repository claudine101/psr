...
// exit();
        $session = array(
          ...
          'FOURRIERE' => $droit['FOURRIERE'],
          'CHEF_MENAGE'=> $droit['CHEF_MENAGE'],
          'GESTION_CHEF_MENAGE'=> $droit['GESTION_CHEF_MENAGE']
        );
        ...
        if ($this->session->userdata('FOURRIERE') == 1) {
          redirect(base_url('ihm/Fourriere/index'));
        }
