...
class  Infra_infractions extends CI_Controller
{
	...
	function listing()
	{
		...
		$query_principal='SELECT ID_INFRA_INFRACTION,NIVEAU_ALERTE,type_verification.VERIFICATION FROM infra_infractions JOIN type_verification ON type_verification.ID_TYPE_VERIFICATION=infra_infractions.ID_TYPE_VERIFICATION';
