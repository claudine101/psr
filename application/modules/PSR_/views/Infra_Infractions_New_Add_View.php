          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('Rapport/Infra_Infractions_New/add'); ?>" >
                 ...
                 <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select required class="form-control" name="ID_TYPE_VERIFICATION" id="ID_TYPE_VERIFICATION" >
                      ...
                      {
                        ?>
                        <option value="<?=$value['ID_TYPE_VERIFICATION']?>"><?=$value['CATEGORIES']?></option>
                        <?php
                      }
                      ?>
                    </select>
