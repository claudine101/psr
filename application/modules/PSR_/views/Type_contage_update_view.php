          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
               ...
               <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Type_contage/update'); ?>" >
                
                <div class="row">
                  <div class="col-md-6">

                    <input type="hidden" class="form-control" name="ID_CONTAGE" value="<?=$data['ID_CONTAGE']?>" >
