...
<div class="form-group col-md-6"><h4 style='color:#FFFFFF'>Tableau de bord des contrôle technique</h4></div>
...
$.ajax({
url : "<?=base_url()?>dashboard/Dashboard_controle_tech/get_rapport",
type : "POST",
dataType: "JSON",
cache:false,
data:{
