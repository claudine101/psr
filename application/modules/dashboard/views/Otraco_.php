...
Highcharts.chart('container1', {
    ...
    subtitle: {
        text: 'voitures avec Assurances valide et non valide'
    },
    xAxis: {
        type: 
            'category'
         ...
         cursor:'pointer',
                        point:{
                            events: {
                                 ...
                                 $("#titre2").html("LISTE DES voitures SELON LEURS validité en Assurances");
                                 $("#myModal2").modal();
...
Highcharts.chart('container', {
    ...
    title: {
        text: '<?=$nom?> voiture au total'
    },
    subtitle: {
        text: 'voitures avec Controle technique valide et non valide'
    },
    xAxis: {
        type: 'category'
    },
