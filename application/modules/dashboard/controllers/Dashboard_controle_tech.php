...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 ...
 credits: {
  ...
  text: \"Mediabox\"
    ...
    {
        color: 'green',
        name:'Contrôles envoyés : (".number_format($immacat_envoy,0,',',' ').")',
        borderColor:\"#FFFF00\",
        data: [".$immaeny_categorie."]
    },
     {
        color: 'yellow',
        name:'Contrôles valable : (".number_format($immacat_valable,0,',',' ').")',
        borderColor:\"#f00000\",
        data: [".$immavalable_categorie."]
    },
    {
        color: 'pink',
        name:'Contrôles expirés : (".number_format($immacat_exp,0,',',' ').")',
        borderColor:\"#90EE90\", 
