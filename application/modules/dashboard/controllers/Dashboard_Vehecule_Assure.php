...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 ...
 credits: {
  ...
  text: \"Mediabox\"
    ...
    {
        color: 'green',
        name:'Assurances envoyés : (".number_format($immacat_envoy,0,',',' ').")',
        borderColor:\"#FFFF00\",
        data: [".$immaeny_categorie."]
    },
     {
        color: '#f27106',
        name:'Assurances valable : (".number_format($immacat_valable,0,',',' ').")',
        borderColor:\"#f00000\",
        data: [".$immavalable_categorie."]
    },
    {
        color: '#6610f2',
        name:'Assurances expirés : (".number_format($immacat_exp,0,',',' ').")',
        borderColor:\"#90EE90\", 
