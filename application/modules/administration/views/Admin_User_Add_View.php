            ...
            <div class="card-body row">
              ...
              <div class="card-body">
                <div class="basic-form">
                  <form method="post" action="<?=base_url()?>administration/Admin_User/add_user">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label style="font-weight: 900; color:#454545">Nom <span class="text-danger">*</span></label>
                        <input type="text" autocomplete="off" class="form-control" name="NOM" id="NOM" placeholder="Nom de l'utilisateur" value="<?=set_value('NOM');?>">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" autocomplete="off" class="form-control" name="PRENOM" id="PRENOM" placeholder="Prénom de l'utilisateur" value="<?=set_value('PRENOM');?>">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="ID_RESTAURANT">
                          ...
                          <?php
                            ...
                            {
                              if ($restora['ID_RESTAURANT']==set_value('ID_RESTAURANT'))
                              {
                          ?>
                      ...
                      <div class="form-group col-md-6">
                        <label style="font-weight: 900; color:#454545">Profile de l'utilisateur <span class="text-danger">*</span></label>
                        <select class="form-control" name="PROFIL_ID">
                          <option value="">---Sélectionner---</option>
                          <?php
                            foreach($admin_profil as $pro)
                            {
                              if ($pro['PROFIL_ID']==set_value('PROFIL_ID'))
                              {
                          ?>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" autocomplete="off" class="form-control" name="TELEPHONE1" id="TELEPHONE1" placeholder="Téléphone 1 de l'utilisateur" value="<?=set_value('TELEPHONE1');?>">
                        <?php echo form_error('TELEPHONE1', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-6">
                        <label style="font-weight: 900; color:#454545">Téléphone 2 </label>
                        <input type="number" autocomplete="off" class="form-control" name="TELEPHONE2" id="TELEPHONE2" placeholder="Téléphone 2 de l'utilisateur" value="<?=set_value('TELEPHONE2');?>">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="email" autocomplete="off" class="form-control" name="EMAIL" id="EMAIL" placeholder="example@gmail.com" value="<?=set_value('EMAIL');?>">
