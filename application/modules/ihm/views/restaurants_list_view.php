    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4 text-right">
              ...
              <span style="margin-right: 15px">
                ...
                <div class="col-sm-6" style="float:right;">
                  <a href="<?=base_url('ihm/Restaurants/ajouter')?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
      ...
      <thead>
        <tr>
          ...
          <td class="inline-block">DESCRIPTION RESTAURANT</td>
          <td>LOCALISATION</td>
          <td>RESPONSABLE</td>
          <td>CONTACTS</td>
          <td>IS_ACTIF</td>
...
{  
  $('#message').delay('slow').fadeOut(3000);
   $("#reponse1").DataTable({
    ...
    "oreder":[],
    "ajax":{
      url: "<?php echo base_url('ihm/Restaurants/listing/');?>", 
      type:"POST",
      data : {   },
      beforeSend : function() {
      }
