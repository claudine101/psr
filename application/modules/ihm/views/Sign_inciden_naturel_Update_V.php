...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Sign_inciden_naturel/update'); ?>" >
                 <div class="row">
                  <input type="hidden" class="form-control" name="ID_SIGN_INCIDENT" value="<?=$datas['ID_SIGN_INCIDENT']?>" >
