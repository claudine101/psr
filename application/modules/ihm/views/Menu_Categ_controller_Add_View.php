          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
               ...
               <form  method="POST" enctype="multipart/form-data"  action="<?= base_url('ihm/Menu_Categ_controller/add'); ?>" >
                

               <div class="row">
                  <div class="col-md-6">
                    <label for="FName">categories</label>
                    <input type="text" name="NOM_CATEGORIE" autocomplete="off" id="NOM_CATEGORIE" value="<?= set_value('NOM_CATEGORIE') ?>"  class="form-control">
