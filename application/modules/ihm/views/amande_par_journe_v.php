                ...
                <div class="row"> 
                 <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <select class="form-control" onchange="rapport()" name="date_insert" id="date_insert" >
                      <option value="">Sélectionner</option>
                      <?php
...
<script>
  Highcharts.chart('container', {
    ...
    title: {
      text: '<b>Les montant </b><br>Total=(<?=$nombre?>) par police'
    },
        ...
        events: {
          click: function()
          {
            ...
            $("#mytable2").DataTable({
              ...
              "oreder":[],
              "ajax":{
                url:"<?=base_url('dashboard/Amende_percu_journe')?>",
                type:"POST",
                data:{
                 key:this.key,
