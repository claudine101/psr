          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Fourriere/add'); ?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      ...
                      <input type="text" name=" CARTE_ROSE" autocomplete="off" id="CARTE_ROSE" value="<?= set_value(' CARTE_ROSE') ?>" class="form-control">
                      <?php echo form_error(' CARTE_ROSE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName">Fourrière</label>
                      <input type="text" name="NOM_FOURRIERE" autocomplete="off" id="NOM_FOURRIERE" value="<?= set_value('NOM_FOURRIERE') ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="tel" name="NIF" autocomplete="off" id="NIF" value="<?= set_value('NIF') ?>" class="form-control">
                      <?php echo form_error('NIF', '<div class="text-danger">', '</div>'); ?>
                    </div>

                    <div class="col-md-6">
                      <label for="FName"> Nom du responsable</label>
                      <input type="text" name="NON_DU_RESPONSABLE" autocomplete="off" id="NON_DU_RESPONSABLE" value="<?= set_value('NON_DU_RESPONSABLE') ?>" class="form-control">
                      <?php echo form_error('NON_DU_RESPONSABLE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName"> Email</label>
                      <input type="text" name=" EMAIL_FROURRIERE" autocomplete="off" id=" EMAIL_FROURRIERE" value="<?= set_value('  EMAIL_FROURRIERE') ?>" class="form-control">
                      <?php echo form_error(' EMAIL_FROURRIERE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                     <div class="col-md-6">
                      <label for="FName">Téléphone</label>
                      <input type="text" name=" TELEPHONE_FOURRIERE" autocomplete="off" id=" TELEPHONE_FOURRIERE" value="<?= set_value('  TELEPHONE_FOURRIERE') ?>" class="form-control">
                      <?php echo form_error(' TELEPHONE_FOURRIERE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="Ftype">Type de la fourrière</label>
                      <select required class="form-control" name="TYPE_FOURRIERE" id="TYPE_FOURRIERE">
                        <option value="">---Sélectionner---</option>
                        <?php
                        foreach ($types as $value) {
                        ?>
                          <option value="<?= $value['ID_TYPE_FOURR'] ?>"><?= $value['TYPE_FOURRIERE'] ?></option>
                        <?php
                        }
                        ?>
                      </select>
                    ...
                    <div class="col-md-6">
                      ...
                      <select required class="form-control" name="PROVINCE_ID" id="PROVINCE_ID" onchange="get_communes();">
                        <option value="">---Sélectionner---</option>
                        <?php
