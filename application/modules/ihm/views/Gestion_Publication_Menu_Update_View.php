...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?=base_url('ihm/Menu/index')?>" class='btn btn-primary float-right'>
    ...
    <form  name="myform" method="POST" enctype="multipart/form-data" action="<?= base_url('ihm/Menu/update'); ?>" >
      <div class="row">
        <input type="hidden" class="form-control" name="ID_MENU" value="<?=$piece['ID_MENU']?>" >
              
           <div class="col-md-6">
            <label">CATEGORIES</label>
                
              <select class="form-control" data-live-search="true"  name="ID_CATEGORIE" >
               <?php 
               foreach($marque as $key_marque) { 
                if ($key_marque['ID_CATEGORIE']==$data['ID_CATEGORIE']) { 
                 // echo "<option value='".$key_marque['ID_CATEGORIE']."' selected>".$key_marque['NOM_CATEGORIE']."</option>";
                  $selected="selected";
        ...
        <div class="col-md-6">
                <label for="FName">MENUS</label>
                  <input type="text" name="NOM_MENU" autocomplete="off" id="NOM_MENU" value="<?=$piece['NOM_MENU'] ?>"  class="form-control">
      ...
      <div class="row">
            <div class="col-md-6">
                <label for="FName">DESCRIPTION</label>
                  <input type="text" name="DESCRIPTION" autocomplete="off" id="DESCRIPTION" value="<?=$piece['DESCRIPTION'] ?>"  class="form-control">
              ...
              <div class="col-md-6 row">
                  ...
                  <label class="label" data-toggle="tooltip" title="Attacher un fichier">
                        ...
                        <input type="file" class="sr-only" id="PHOTO_DEUX" name="PHOTO_DEUX" accept="image/*" required>
                  </label>
                  </div>
