      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?=base_url('ihm/Sign_inciden_naturel/index')?>" class='btn btn-primary float-right'>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12"> 
                ...
                <form  name="myform" method="post" class="form-horizontal" enctype="multipart/form-data" action="<?= base_url('ihm/Sign_inciden_naturel/add'); ?>" >
                 <div class="row">


                  <div class="col-md-6">
                    <label for="Ftype">NOM</label>
                    <select required class="form-control" name="NOM" id="ID_UTILISATEUR" >
                      <option value="">---Sélectionner---</option>
                      <?php
                      foreach ($users as $value)
                      {
                        ?>
                        <option value="<?=$value['ID_UTILISATEUR']?>"><?=$value['NOM']?></option>
                        <?php
                      }
                      ?>
                    </select>
