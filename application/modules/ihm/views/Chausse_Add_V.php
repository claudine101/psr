          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Chaussee/add'); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <label for="FName">CHAUSSEE</label>
                      <input type="text" name="NOM_CHAUSSE" autocomplete="off" id="FR" class="form-control">
