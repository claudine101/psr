          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                $modalData = json_decode($data['COULEUR_TRADUCTION'], true);
                // print_r($modalData);
                // exit(); 
                ?>
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Couleur/update'); ?>">

                  <div class="row">
                    <div class="col-md-6">

                      <input type="hidden" class="form-control" name="ID_TYPE_COULEUR" value="<?= $data['ID_TYPE_COULEUR'] ?>">
                      <label for="FName">COULEUR</label>
                      <input type="text" name="COULEUR" value="<?= $data['COULEUR'] ?>" id="FR" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden" name="COULEUR_TRADUCTION" autocomplete="off" id="COULEUR_TRADUCTION" class="form-control" value="<?= htmlentities($data['COULEUR_TRADUCTION']) ?>">
