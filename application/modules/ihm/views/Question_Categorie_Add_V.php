          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Question_Categorie/add'); ?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="CATEGORIES" autocomplete="off" id="FR" value="<?= set_value('CATEGORIES') ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden" name="QUESTIONNAIRE_TRADUCTION" autocomplete="off" id="QUESTIONNAIRE_TRADUCTION" class="form-control">
