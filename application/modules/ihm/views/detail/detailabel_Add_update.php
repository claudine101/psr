      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?= base_url('ihm/DetailLabel/index/') . $id_question ?>" class='btn btn-primary float-right'>
      ...
      <section class="content">
        <div class="col-md-12 col-xl-12 grid-margin stretch-card">
          ...
          <div class="card">
            <div class="card-body">
              <div class="col-md-12">
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/DetailLabel/update'); ?>">
                  <div class="row">

                    <input type="hidden" class="form-control" name="id_question" value="<?= $id_question ?>">
                    <input type="hidden" class="form-control" name="id_reponse" value="<?= $id_reponse ?>">



                    <div class="col-md-4">
                      <label for="FName"><?= $label['LABEL_REPONSE'] ?></label>
                      <input required type="text" name="REPONSE_DECRP" autocomplete="off" id="FR" value="<?= htmlentities($reponse['REPONSE_DECRP']) ?>" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <!-- <input required type="text" name="REPONSE_DECRP_TRADUCTION" autocomplete="off" id="REPONSE_DECRP_TRADUCTION" value='' class="form-control" required> -->
                       ...
                       <textarea readonly name="REPONSE_DECRP_TRADUCTION"  id="REPONSE_DECRP_TRADUCTION" class="form-control" required><?=$reponse["REPONSE_DECRP_TRADUCTION"] ?></textarea>
