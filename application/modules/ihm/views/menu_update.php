          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Menu/update'); ?>" >
      <div class="row">
            ...
            <label">CATEGORIES</label>
              ...
              <select class="form-control" data-live-search="true"  name="ID_CATEGORIE" >
               ...
               foreach($marque as $key_marque) { 
                if ($key_marque['ID_CATEGORIE']==$piece['ID_CATEGORIE']) { 
                 echo "<option value='".$key_marque['ID_CATEGORIE']."' selected>".$key_marque['NOM_CATEGORIE']."</option>";
                 
                }else{
                 echo "<option value='".$key_marque['ID_CATEGORIE']."' > ".$key_marque['NOM_CATEGORIE']."</option>"; 
               } }?>
             </select> 
