          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
               ...
               <form  method="post" enctype="multipart/form-data"  action="<?= base_url('ihm/Publicites/add'); ?>" >
                <div class="row">
                  ...
                  <option value="">Sélectionner</option>
                    <?php 
                      foreach ($resto as $key_resto) 
                          {
                      if ($key_resto['ID_RESTAURANT']==set_value('ID_RESTAURANT')) 
                              {?>
                                <option value="<?= $key_resto['ID_RESTAURANT'] ?>" selected=''><?= $key_resto['NOM_RESTAURANT'] ?></option>
                              <?php } else {?>
                                <option value="<?= $key_resto['ID_RESTAURANT'] ?>"><?= $key_resto['NOM_RESTAURANT'] ?></option>
                                <?php 
                              }
                            }
                   ...
                   <div class="col-md-6">
                    ...
                    <input type="text" name="PUB_URL" autocomplete="off" id="PUB_URL" value="<?= set_value('PUB_URL') ?>"  class="form-control">
