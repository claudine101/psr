          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('menage/Chefs_menage/update'); ?>">

                  <div class="row">

                    <div class="col-md-6">
                      <input type="hidden" class="form-control" name="ID_CHEF" value="<?= $membre['ID_CHEF'] ?>">
