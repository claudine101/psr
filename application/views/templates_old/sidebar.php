...
<!-- rapport/Rapport_Financier -->
          ...
          <li class="nav-item">
            <a href="#" class="nav-link <?php if ($this->router->class == 'Dashboard_Signalement' || $this->router->class == 'Dashboard_Constats' || $this->router->class == 'Dahboard_Grobal')  echo 'active'; ?>">
             ...
             <ul class="nav nav-treeview">
              ...
              <!--  <li class="nav-item">
                <a href="<?= base_url('dashboard/Dahboard_Grobal') ?>" class="nav-link <?php if ($this->router->class == 'Dahboard_Grobal') echo 'active'; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Signalement global</p>
                </a>
              </li> -->
        ...
        <?php if ($this->session->userdata('PSR_ELEMENT') == 1) { ?>
          <li class="nav-item">
            <a href="#" class="nav-link <?php if ($this->router->class == 'Obr_Immatriculation' || $this->router->class == 'Chauffeur_permis' || $this->router->class == 'Controle' || $this->router->class == 'Declaration_Vol') echo 'active'; ?>">
              <i class="nav-icon fas fa-database"></i>
              <p>
                Données
                <i class="right fas fa-angle-left"></i>
        ...
        <?php } ?>
        <?php if ($this->session->userdata('SIGNALEMENT') == 1 || $this->session->userdata('PSR_ELEMENT') == 1) { ?>
          ...
          <li class="nav-item">
           ...
           <!--    <li class="nav-item">
                <a href="<?= base_url('ihm/Historique_signalement/index') ?>" class="nav-link <?php if ($this->router->class == 'Historique_signalement') echo 'active'; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Historique signalement</p>
                </a>
              </li>
             ...
             <!--  <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?= base_url('ihm/Sign_inciden_naturel/index') ?>" class="nav-link <?php if ($this->router->class == 'Sign_inciden_naturel') echo 'active'; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Incident Naturel</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="<?= base_url('ihm/Sign_autres_signal/index') ?>" class="nav-link <?php if ($this->router->class == 'Sign_autres_signal') echo 'active'; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Autres</p>
                </a>
              </li> -->
