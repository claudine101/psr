...
public function do_login() {
    ...
    $droit= $this->Model->getRequeteOne('SELECT ID_DROIT, INFRACTION, PSR_ELEMENT, PEINES, AFFECTATION, PERMIS,DECLARATION, IMMATRICULATION, CONTROLE_TECHNIQUE, ASSURANCE, PROFIL_ID FROM droits WHERE PROFIL_ID="'.$user['PROFIL_ID'].'" ');
